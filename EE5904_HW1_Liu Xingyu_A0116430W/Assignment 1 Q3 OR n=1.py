...
"""Plot the OR Implementation and weight changing trajectories versus iteration"""
a = np.arange(3)    
step = np.arange(total_iter+1)
fig, axes = plt.subplots(2, 1, figsize=(8, 8))
axes[0].plot(a,-(b*a)-c)
axes[0].scatter(0,0,color = 'red',label = 'class y = 0')
axes[0].scatter(0,1,color = 'green',label = 'class y =1')
axes[0].scatter(1,0,color = 'green',label = 'class y =1')
axes[0].scatter(1,1,color = 'green',label = 'class y =1')
axes[0].legend(loc = 'best')
axes[0].set_xlabel('Value of x1')
axes[0].set_ylabel('Value of x2')
axes[0].set_title('OR Implementation')
