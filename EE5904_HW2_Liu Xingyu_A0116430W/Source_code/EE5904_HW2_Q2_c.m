...
xlabel('x')
ylabel('y')
str1 = sprintf('Batch mode, trainbr, ytest, %d neurons', n);
title(str1)
xlim([-3 3])
subplot(2,1,2)
...
xlabel('x')
ylabel('y')
str2 = sprintf('Batch mode, trainbr, prediction on interval -3 to 3, %d neurons', n);
title(str2)
saveas(gcf, ['Batch mode, number of neurons ', num2str(n), ' trainbr'], 'png');
end
